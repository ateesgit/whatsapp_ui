...
const mobileChatBoxColor = Color.fromRGBO(31, 44, 52, 1);
 final customColorScheme = ColorScheme.dark().copyWith(
      primary: Colors.green, // Replace with your desired primary color
      secondary: Colors.blue, // Replace with your desired secondary color
      // Add more color customization as needed
    );
